...
-- Type your code below:
Select count(id) as Number_of_Movies , genre from movie
...
-- Type your code below:
Select count(movie_id) as Number_of_Movies from genre where movie_id in
(
